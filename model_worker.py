...
def create_model_worker():
    ...
    parser.add_argument("--worker-address", type=str, default=public_url_2)
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    port = 21000
    public_url = ngrok.connect(port,schemes=["http","https"]).public_url
    print("ngrok tunnel \"{}\" -> \"http://127.0.0.1:{}\"".format(public_url, port))
    public_url_2 =f'{public_url}:443'
